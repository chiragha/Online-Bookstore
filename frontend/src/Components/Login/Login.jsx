...
function Login() {
  ...
  <div className="modal-box">
   ...
   {/* password section */}
    <div className="mt-4">
       <span>Password:</span>
       <input type="password" name='password' placeholder='Enter Your Password' className='w-80 px-3 m-2 border rounded-md outline-none' {...register("password", { required: true })}/>
       <br/>
